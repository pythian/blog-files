...
Note:  this directory contains all files used for Client Results Cache, both for dev and a blog article.

There are files here that are not kept in any repo.
